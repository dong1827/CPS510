...
function Register() {
    ...
    */
    ...
    const [msg, setMsg] = useState('Welcome to M&M Database!');
    ...
    const handleSubmit = async (event) => {
        ...
        */
        ...
        try {
            ...
            const response = await axios.post('https://visually-talented-grubworm.ngrok-free.app/register',  { username, password });
